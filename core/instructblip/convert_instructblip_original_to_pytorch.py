...
# Optional: float32-friendly fork: pip install git+https://github.com/salesforce/LAVIS.git@fix_lavis_float32
# For Vicuna conversions, point lavis/configs/models/blip2/blip2_instruct_vicuna7b.yaml to a local Vicuna checkpoint (13B uses the same tweak).
